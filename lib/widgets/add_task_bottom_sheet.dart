...
/// Minutes between [start] and [end] on the same calendar day.
...
/// Grouped “bento” block inside add/edit task sheets (spacing + soft glass card).
Widget buildTaskFormSheetSection({
...
/// Shared glass bottom sheet for adding a task (Tasks + Calendar).
class AddTaskBottomSheet {
  AddTaskBottomSheet._();

  static Future<void> show(
    BuildContext context, {
    required TaskViewModel taskVM,
    ScheduledTaskViewModel? scheduledTaskVM,
    required DateTime initialTaskDate,
    void Function(DateTime taskDate)? onTaskCreated,
  }) async {
    ...
    var taskDate = DateTime(
      initialTaskDate.year,
      initialTaskDate.month,
      initialTaskDate.day,
    );
                              ...
                              SafeArea(
                                ...
                                child: Padding(
                                  ...
                                  onPressed: () async {
                                    ...
                                    final scheduledVM = scheduledTaskVM ??
                                        Provider.of<ScheduledTaskViewModel>(sheetContext, listen: false);
